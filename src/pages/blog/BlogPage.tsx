          ...
          <div className="flex justify-center mt-12">
            <nav aria-label="Blog pagination">
              <ul className="flex items-center">
                <li>
                  <a href="#" className="px-3 py-2 ml-0 leading-tight text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700">
                    Previous
                  </a>
                </li>
                <li>
                  <a href="#" className="px-3 py-2 text-blue-600 border border-gray-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700">
                    1
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#" className="px-3 py-2 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700">
                    Next
                  </a>
                </li>
              </ul>
